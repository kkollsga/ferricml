...
pub(crate) const RANDOM_FOREST_CLASSIFIER_ARTIFACT_KIND: u16 = 11;
pub(crate) const ANY_REGRESSOR_ARTIFACT_KIND: u16 = 12;
pub(crate) const ANY_CLASSIFIER_ARTIFACT_KIND: u16 = 13;
...
pub(crate) const POLYNOMIAL_FEATURES_ARTIFACT_KIND: u16 = 46;
